    ...
    let music_list = [
      {
        ...
        music: "_Aar_Nanak_Paar_Nanak_(Full_Video)_Gurmoh__White_Hill_Music__New_Punjabi_Songs(128k).mp3",
      },
      {
        img: "images/img2.png",
        name: "Aasique Mudna Jave",
        artist: "Akhil",
        music: "_Aashiq_Mud_Na_Jaawe_(Full_Video)_Ft._Adah_Sharma__BOB__New_Punjabi_Songs_2021(128kbps).mp3",
      },
    ];
